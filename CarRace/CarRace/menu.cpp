...
void Menu::LoadAssests()
{
    ...
    click.loadFromFile("sound\\click.ogg");
    click_sound.setBuffer(click);

    font.loadFromFile("font\\font.ttf");

    introMusic.openFromFile("sound\\intro sound.ogg");
...
Menu::Menu(int width, int height)
{
    ...
    this->intro_img2.loadFromFile("images\\background\\intro2.png");
...
bool LoadMenu(sf::RenderWindow& app, bool flowIntro)
{
    ...
    intro_img.loadFromFile("images\\background\\intro.png");
...
void Menu::DrawHighScores(sf::RenderWindow& app)
{
    ...
    sf::Font font;
    font.loadFromFile("font\\Crang.ttf"); // Replace with the path to your font file
